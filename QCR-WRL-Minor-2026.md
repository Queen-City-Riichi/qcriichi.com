---
title: QCR WRL Minor 2026
layout: page
description: Information about the 2026 QCR World Riichi League Minor tournament.
---
...
- **Format**:
  ...
  - For physical prizes, players are ranked by their cumulative outcome over 4 hanchan
- **Date**: June 14, 2026 (Sunday)
- **Time**: 9:30 AM - 6:00 PM for the tournament. Free play until 11:30 PM.
...
- **Entry fee**: $30. Venmo is preferred: `@Peter-Gao (2322)`.

## Results and Seating Info

- Table and seat assignments will be finalized before the tournament start.
- Please use the [World Riichi App](https://worldriichileague.com/app/) to track the table/seat assignments, current standings, etc.
...
| 05:30 PM   | Awards          |
| 06:00 PM   | Free Play       |
| 11:30 PM   | Venue Close     |


## Amenities and Food

There will be free coffee in the hotel lobby, and free ice water in the tournament room.

The hotel has a snack bar for quick bites (not free).

There are many fast food restaurants within a few mintues of walk: Skyline Chili, Popeyes, etc.
...
We use the [WRC 2025 Ruleset], without any modification.
...
- Scores from the 4 hanchan played in this tournament can count toward qualifying for the WRL Finals.
...
Your spot is confirmed upon paying the $30 entry fee. Venmo is preferred: `@Peter-Gao (2322)`; please reach out for other payment methods.
...
- Refunds are only honored for emergency withdrawals, evaluated on a case-by-case basis. Please reach out for questions.
